...
@WebServlet(value = "/xpathi-00/BenchmarkTest02744")
public class BenchmarkTest02744 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("BenchmarkTest02744_value", "9999");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String sessionValue =
                (String) request.getSession().getAttribute("BenchmarkTest02744_value");
