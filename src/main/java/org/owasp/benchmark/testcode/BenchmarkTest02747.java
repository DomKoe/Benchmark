...
@MultipartConfig
@WebServlet(value = "/xpathi-00/BenchmarkTest02747")
public class BenchmarkTest02747 extends HttpServlet {
    ...
    // Extra data-flow hop: the raw part content is trimmed and lower-cased through a helper
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String raw = null;
        Part part = request.getPart("BenchmarkTest02747");
        if (part != null) {
            raw = org.apache.commons.io.IOUtils.toString(part.getInputStream(), "UTF-8");
        }
        String bar = normalize(raw);
