...
@MultipartConfig
@WebServlet(value = "/xpathi-00/BenchmarkTest02746")
public class BenchmarkTest02746 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // The uploaded part's content is read but discarded; only a hardcoded value is used in
        // the XPath query below, so the taint never reaches the sink.
        Part part = request.getPart("BenchmarkTest02746");
        if (part != null) {
