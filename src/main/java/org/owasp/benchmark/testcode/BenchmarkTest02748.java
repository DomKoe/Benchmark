...
@MultipartConfig
@WebServlet(value = "/xpathi-00/BenchmarkTest02748")
public class BenchmarkTest02748 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // The uploaded part is read (to exercise the same normalize() helper as the vulnerable
        // sibling test) but its value is discarded; a hardcoded constant is used instead.
        Part part = request.getPart("BenchmarkTest02748");
        if (part != null) {
            normalize(org.apache.commons.io.IOUtils.toString(part.getInputStream(), "UTF-8"));
        }
        String bar = normalize("12345");
