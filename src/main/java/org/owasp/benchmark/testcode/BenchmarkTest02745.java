...
// Source dimension not otherwise exercised by any xpathi test case: multipart form-data,
// read via HttpServletRequest.getPart(), rather than a header/parameter/cookie/URI.
@MultipartConfig
@WebServlet(value = "/xpathi-00/BenchmarkTest02745")
public class BenchmarkTest02745 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String bar = "";
        Part part = request.getPart("BenchmarkTest02745");
        if (part != null) {
