...
// Source dimension not otherwise exercised by any ldapi test case: multipart form-data.
@MultipartConfig
@WebServlet(value = "/ldapi-00/BenchmarkTest02755")
public class BenchmarkTest02755 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String param = "";
        Part part = request.getPart("BenchmarkTest02755");
        if (part != null) {
